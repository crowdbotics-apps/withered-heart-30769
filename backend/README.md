...
## Project Structure
    ...
    ├── withered_heart_30769  # Django project configurations
...
1. Clone this repo and `cd withered_heart_30769`
...
2. Clone this repo and `cd withered_heart_30769`
